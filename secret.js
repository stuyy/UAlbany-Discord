...
client.login("NDc0NjUxNDM4ODI4NDg2NjU2.DkTlLg.QLHj1S8vTTIcgWcS0TP5-m5SWJo");
  ...
  else if(message.content.startsWith("!addrole"))
  {
    ...
    if(message.channel.name === "bot2" || message.channel.name === "bot")
    {
      ...
      if(argLength>2)
      {
        ...
        while(i<argLength)
        {
          if(botinfo.hasOwnProperty(args[i])) // Check if in JSON
          {
            console.log(botinfo[args[i]]);
            //console.log(botinfo.majors[0][args[i]]);
