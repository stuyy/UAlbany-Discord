...
exports.showRules = function(message)
{
  ...
  if(channel != null)
  {
    ...
    .addField("Harassments", "\nAny form of harassment towards server staff or community members. This will result in consequences that scale upon the severity of harassment.\n")
